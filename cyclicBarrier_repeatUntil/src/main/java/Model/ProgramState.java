...
public class ProgramState {
    ...
    private final IBarrier barrierTable;
    ...
    public ProgramState(IStack<IStatement> execStack, IDictionary<String, Values> symTable, IList<String> out, IDictionary<String, BufferedReader> fileTable, IHeap heap, IBarrier barrierTable) {
