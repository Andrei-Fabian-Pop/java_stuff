...
public class ProgramState {
    ...
    public ProgramState(IStack<IStatement> execStack, IDictionary<String, Values> symTable, IList<String> out, IDictionary<String, BufferedReader> fileTable, IHeap heap, ISemaphore semaphore) {
