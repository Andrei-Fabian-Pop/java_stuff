...
public class ExamplesView implements View {
    ...
    protected static IStatement example8() {
        return buildExample(
                ...
                new AssStatement("a", new ValueExpression(new IntValue(1))),
                new AssStatement("b", new ValueExpression(new IntValue(2))),
                new AssStatement("c", new ValueExpression(new IntValue(5))),
                new Switch(
                        new ArithExpression(BinaryExpression.OPERATOR.MULT, new VariableExpression("a"), new ValueExpression(new IntValue(10))),
                        new ArithExpression(BinaryExpression.OPERATOR.MULT, new VariableExpression("b"), new VariableExpression("c")),
                        buildExample(
    ...
    protected static IStatement example9() {
        return buildExample(
                ...
                new New("v", new ValueExpression(new IntValue(1))),
                new CreateSemaphore("cnt", new ReadHeap(new VariableExpression("v"))),
                new ForkStatement(
                        buildExample(
                                new Acquire("cnt"),
                                new WriteHeap("v", new ArithExpression(
