...
public class ExamplesView implements View {
    ...
    protected static IStatement example8() {
        return buildExample(
                ...
                new DeclarationStatement("v", new IntType()),
                new New("a", new ValueExpression(new IntValue(0))),
                new New("b", new ValueExpression(new IntValue(0))),
    ...
    protected static IStatement example9() {
        return buildExample(
                ...
                new NewLatch("cnt", new ReadHeap(new VariableExpression("v2"))),
                new ForkStatement(
                        buildExample(
                                ...
                                new ForkStatement(
                                        buildExample(
                                                ...
                                                new ForkStatement(
                                                        buildExample(
                                                                new WriteHeap("v3", new ArithExpression(
                                                                        BinaryExpression.OPERATOR.MULT,
                                                                        new ReadHeap(new VariableExpression("v3")),
                                                                        new ValueExpression(new IntValue(10))
                                                                )),
