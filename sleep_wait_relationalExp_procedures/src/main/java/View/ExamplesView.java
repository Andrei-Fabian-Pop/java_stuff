...
public class ExamplesView implements View {
    ...
    protected static IStatement example8() {
        return buildExample(
                ...
                new AssStatement("v1", new ValueExpression(new IntValue(2))),
                new AssStatement("v2", new ValueExpression(new IntValue(3))),
                new IfStatement(
                        new RelationalExpression(
    ...
    protected static IStatement example9() {
        return buildExample(
                new DeclarationStatement("v", new IntType()),
                new AssStatement("v", new ValueExpression(new IntValue(20))),
    ...
    protected static IStatement example10() {
        return buildExample(
                new Procedure("sum", Arrays.asList("a", "b"),
                        buildExample(
                ...
                new Procedure("product", Arrays.asList("a", "b"),
                        buildExample(
                                new AssStatement("v", new ArithExpression(
                                        BinaryExpression.OPERATOR.MULT,
                                        new VariableExpression("a"),
                ...
                new AssStatement("v", new ValueExpression(new IntValue(2))),
                new AssStatement("w", new ValueExpression(new IntValue(5))),
                new Call(
                        "sum",
                        Arrays.asList(
                                new ArithExpression(
                ...
                new ForkStatement(
                        buildExample(
                                new Call("product", Arrays.asList(new VariableExpression("v"), new VariableExpression("w"))),
                                new ForkStatement(
                                        buildExample(
                                                new Call("sum", Arrays.asList(new VariableExpression("v"), new VariableExpression("w")))
                                        )
                                )
                        )
                )
    ...
    public static IStatement[] exampleList() {
        return new IStatement[]{example0(), example1(), example2(), example3(), example4(), example5(), example6(), example7(), example8(), example9(), example10()};
    }
