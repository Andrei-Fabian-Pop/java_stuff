...
public class ExamplesView implements View {
    ...
    protected static IStatement example8() {
        return buildExample(
                new DeclarationStatement("a", new RefType(new IntType())),
                new New("a", new ValueExpression(new IntValue(20))),
                new ForStatement(
                        "i",
                        new ValueExpression(new IntValue(0)),
                        new ValueExpression(new IntValue(3)),
                        ...
                        new ForkStatement(
                                buildExample(
                                        ...
                                        new AssStatement("i", new ArithExpression(
    ...
    protected static IStatement example9() {
        return buildExample(
                ...
                new ForkStatement(
                        buildExample(
                                new ForkStatement(
                                        buildExample(
                                                new LockLock("x"),
                                                new WriteHeap("v1", new ArithExpression(
                                                        BinaryExpression.OPERATOR.SUBSTR,
                ...
                new ForkStatement(
                        buildExample(
                                new ForkStatement(
                                        buildExample(
                                                new LockLock("q"),
                                                new WriteHeap("v2", new ArithExpression(
                                                        BinaryExpression.OPERATOR.ADD,
                ...
                new NopStatement(),
                new NopStatement(),
                new LockLock("x"), new PrintStatement(new ReadHeap(new VariableExpression("v1"))), new LockUnlock("x"),
                new LockLock("q"), new PrintStatement(new ReadHeap(new VariableExpression("v2"))), new LockUnlock("q")
        );
    }
